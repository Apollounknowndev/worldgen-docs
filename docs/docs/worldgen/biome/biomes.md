...
* ‌<or>[B]</or> `has_precipitation`: Determines whether or not preciptation happens. If the biome temperature is low enough, the precipitation will be snow instead of rain.
